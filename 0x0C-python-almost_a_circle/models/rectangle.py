...
class Rectangle(Base):
    ...
    def area(self):
        """
        Here Return area of the rectangle
        """
    ...
    def __str__(self):
        """
        Here Return the print() and str() representation of the Rectangle.
        """
    ...
    def update(self, *args, **kwargs):
        """
        Here Assign arguments to attributes based on their positions.
        """
        if args:
